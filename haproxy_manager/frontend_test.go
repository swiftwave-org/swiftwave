...
func TestFrontend(t *testing.T) {
	...
	t.Run("delete tcp frontend with switching rules should delete frontend", func(t *testing.T) {
		...
		backendName, err := haproxyTestManager.AddBackend(transactionId, TCPMode, "service", 8080, 1)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("delete http frontend with switching rules should not delete frontend", func(t *testing.T) {
		...
		backendName, err := haproxyTestManager.AddBackend(transactionId, HTTPMode, "service", 8080, 1)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("delete http frontend with all switching rules delete should delete frontend", func(t *testing.T) {
		...
		backend1Name, err := haproxyTestManager.AddBackend(transactionId, HTTPMode, "service", 8080, 1)
		if err != nil {
			t.Fatal(err)
		}
		backend2Name, err := haproxyTestManager.AddBackend(transactionId, HTTPMode, "service", 8081, 1)
		if err != nil {
			t.Fatal(err)
		}
